...
function RidePopUp(props){
    return(
        <div className="lg:w-1/2 lg:bg-white lg:px-3">
            <div className="flex items-center justify-between w-full px-3 py-2">
                <h3 className="text-xl font-semibold">New Ride Available</h3>
                <i className="ri-arrow-down-s-line" onClick={()=>{props.setRidePopPanel(false)}} ></i>
            </div>
            ...
            <div className="flex flex-col items-center justify-center w-full pb-4">               
                ...
                <div className="w-full flex items-center gap-3">
                    <button onClick={()=>{
                        ...
                        }}  className="bg-green-600 hover:bg-green-500 w-1/2 font-medium text-white px-6 py-2 rounded-lg mt-4">
                        Accept
                    </button>
                    <button onClick={()=>{props.setRidePopPanel(false)}} className="bg-gray-300 hover:bg-gray-200 w-1/2 font-medium text-gray-700 px-6 py-2 rounded-lg mt-4">
                        Ignore
                    </button>
                </div>
