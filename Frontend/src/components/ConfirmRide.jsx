    ...
    return(
        <>
            <div className="flex items-center justify-between w-full px-3 py-2">
                ...
                <i className="ri-arrow-down-s-line" onClick={()=>{props.setConfirmRidePanel(false)}} ></i>
            </div>
            <div className="flex flex-col items-center justify-center w-full pb-4">
                ...
                <div className="w-full flex flex-col gap-2">
                    ...
                    <div className="w-full flex items-center gap-6 pl-3">
                        ...
                        <div className="w-full border-b-[1px] border-gray-300 py-2">
                            ...
                            <p className="text-gray-900 text-sm whitespace-nowrap max-w-[80%] overflow-hidden text-ellipsis">{props.destination}</p>
                        </div>
                    </div>
                    <div className="w-full flex items-center gap-6 pl-3">
                ...
                <button onClick={()=>{
                    ...
                    props.createRide()
                    }} className="bg-green-600 hover:bg-green-500 font-medium text-white px-6 py-2 rounded-lg mt-4">Confirm Ride</button>
            </div>
        </>
    )
}
